...
var recordBroadcasterController_exports = {};
__export(recordBroadcasterController_exports, {
  RecordBroadcasterController: () => RecordBroadcasterController
});
module.exports = __toCommonJS(recordBroadcasterController_exports);
...
var RecordBroadcaster = class {
  ...
  static getBroadcasterById(id) {
    return __async(this, null, function* () {
      return yield prisma.broadcastersReocord.findUnique({
        where: {
          id
        }
      });
  ...
  static getBroadcasterFiltered(filter) {
    return __async(this, null, function* () {
      return yield prisma.broadcastersReocord.findMany({
        where: {
          OR: [
            {
              broadcasterName: {
  ...
  createBroadcaster() {
    return __async(this, null, function* () {
      if (broadcastersValidations.city(this.city) && broadcastersValidations.state(this.state) && broadcastersValidations.codec(this.codec)) {
        yield prisma.broadcastersReocord.create({
          data: {
  ...
  updateBroadcaster(id) {
    return __async(this, null, function* () {
      if (broadcastersValidations.city(this.city) && broadcastersValidations.state(this.state) && broadcastersValidations.codec(this.codec)) {
        yield prisma.broadcastersReocord.update({
          data: {
            broadcasterName: this.broadcasterName,
            city: this.city,
            state: this.state,
